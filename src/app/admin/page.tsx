...
export default function AdminDashboard() {
  ...
  const loadStats = async () => {
    try {
      ...
      // Try to load stats, but don't redirect on error
      try {
        ...
        // If database fails, still show the page with zeros
        console.warn('Database error, showing zeros:', dbError);
        setStats({
          events: 0,
          tickets: 0,
          revenue: 0,
    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="glass-card p-8 text-center max-w-md">
          ...
          <button
            onClick={loadStats}
            className="px-4 py-2 bg-gradient-to-r from-purple-500 to-blue-500 rounded-xl text-white font-bold hover:opacity-80 transition"
          >
            Try Again
          </button>
        </div>
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-purple-600/10 via-blue-600/5 to-cyan-600/10 border border-white/5 p-6">
        ...
        <div className="relative flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <h1 className="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-blue-400 to-purple-400">
              Global Hub Admin
            </h1>
